...
import { ScrollReveal, StaggerParent, MotionCard, GlowOrb } from "../motion/MotionPrimitives";
import './Features.css';
...
export default function Features() {
  return (
    <section className="features section-padding" id="features">
      <GlowOrb size={600} color="rgba(6, 182, 212, 0.03)" position="top" />
      ...
      <div className="container">
        ...
        <StaggerParent className="features-grid" stagger={0.06}>
          {features.map((feat, i) => (
            ...
            >
              <motion.div
                className={`feat-icon-wrap feat-icon-${feat.color}`}
